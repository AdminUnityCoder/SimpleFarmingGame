...
namespace SimpleFarmingGame.Editor
{
    public class ItemEditor : EditorWindow
    {
        ...
        public void CreateGUI()
        {
            ...
            (
                "Assets/SimpleFarmingGame/Scripts/Game/Editor/UI Builder/ItemEditor.uxml"
            );
            ...
            (
                "Assets/SimpleFarmingGame/Scripts/Game/Editor/UI Builder/ItemRowTemplate.uxml"
            );
        ...
        private void GetItemDetails()
        {
            ...
            m_ItemDetailsSection.Q<IntegerField>("ItemID").RegisterValueChangedCallback
            (
                evt =>
                {
            ...
            m_ItemDetailsSection.Q<TextField>("ItemName").RegisterValueChangedCallback
            (
                evt =>
                {
            ...
            m_ItemDetailsSection.Q<ObjectField>("ItemIcon").RegisterValueChangedCallback
            (
                evt =>
                {
            ...
            m_ItemDetailsSection.Q<ObjectField>("ItemSprite").RegisterValueChangedCallback
            (
                evt =>
                {
            ...
            m_ItemDetailsSection.Q<EnumField>("ItemType").RegisterValueChangedCallback
            (
                evt =>
                {
            ...
            m_ItemDetailsSection.Q<TextField>("Description").RegisterValueChangedCallback
            (
                evt =>
                {
            ...
            m_ItemDetailsSection.Q<IntegerField>("ItemUseRadius").RegisterValueChangedCallback
            (
                evt =>
                {
            ...
            m_ItemDetailsSection.Q<Toggle>("CanPickedup").RegisterValueChangedCallback
            (
                evt =>
                {
            ...
            m_ItemDetailsSection.Q<Toggle>("CanDropped").RegisterValueChangedCallback
            (
                evt =>
                {
            ...
            m_ItemDetailsSection.Q<Toggle>("CanCarried").RegisterValueChangedCallback
            (
                evt =>
                {
            ...
            m_ItemDetailsSection.Q<IntegerField>("Price").RegisterValueChangedCallback
            (
                evt =>
                {
            ...
            m_ItemDetailsSection.Q<Slider>("SellPercentage").RegisterValueChangedCallback
            (
                evt =>
                {
        ...
        private void OnAddItemClicked()
        {
            ...
            newItem.ItemID = 1001 + m_ItemList.Count;
